...
export default function AdminNavBar() {
  ...
  const navItems = [
    { path: "/admin/adminhome", name: "Dashboard", icon: <FiHome size={20} /> },
    { path: "/admin/addseller", name: "Add Seller", icon: <FiUserPlus size={20} /> },
    { path: "/admin/viewsellers", name: "Sellers", icon: <FiUsers size={20} /> },
    { path: "/admin/viewproducts", name: "Products", icon: <FiPackage size={20} /> },
    { path: "/admin/viewusers", name: "Users", icon: <FiUser size={20} /> },
  ];
      ...
      <div className={`flex-1 overflow-auto transition-all duration-300 ${isCollapsed ? "md:ml-20" : "md:ml-64"}`}>
        <div className="p-6">
          <Routes>
            ...
            <Route path="/admin/viewsellers" element={<ViewSellers />} />
